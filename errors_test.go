...
var traceRE = `Trace: message:
 ...
 .*/errgo.f:
	(?:[A-Z]:)?/.*/errgo/errors_test.go#L=21
	(?:[A-Z]:)?/.*/errgo/errors_test.go#L=25
	(?:[A-Z]:)?/.*/errgo/errors_test.go#L=25
	(?:[A-Z]:)?/.*/errgo/errors_test.go#L=25
	(?:[A-Z]:)?/.*/errgo/errors_test.go#L=25
	(?:[A-Z]:)?/.*/errgo/errors_test.go#L=25
...
func (s *S) TestCaller(c *check.C) {
	...
	fn, ln := err.FileLine()
	c.Check(fn, check.Matches, "(?:[A-Z]:)?/.*/errgo/errors_test.go")
	c.Check(ln, check.Equals, 53)
	c.Check(err.Package(), check.Matches, `.*/errgo.\(\*S\)`)
